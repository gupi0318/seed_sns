...
// 会員登録ボタンが押された時
    if(!empty($_POST)){
      ...
      $stmt->execute($data);
       unset($_SESSION);
      // sessionの情報を削除する必要がある。
      // unset指定した関数を削除する(リセットする感じ)
      // sha1=()内の値を１６進数にし、暗号化する関数;
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><div class="text-center">
                    <img src="../picture_path/<?php echo $_SESSION['join']['picture_path']; ?>" alt="" width="240" height="160">

                    <!-- <img src="http://c85c7a.medialib.glogster.com/taniaarca/media/71/71c8671f98761a43f6f50a282e20f0b82bdb1f8c/blog-images-1349202732-fondo-steve-jobs-ipad.jpg" width="100" height="100"> --></div></td>
                </tr>
              </tbody>
            </table>
